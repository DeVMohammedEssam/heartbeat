          ...
          <div className="custom-navbar__content">
            ...
            {this.state.isSignedIn ? (
              <div className="custom-navbar__signed-container">
                {this.props.user.type === 0 && (
                  ...
                  <React.Fragment>
                    <div class="dropdown">
                      <button
                        class="btn  dropdown-toggle custom-navbar__notification"
                        type="button"
                      ...
                      >
                        {this.state.notifications.length > 0 ? (
                          <span className="badge badge-pill count">
                      ...
                      >
                        {this.state.notifications.map(noti => (
                          <Link to="/notifications" class="dropdown-item">
                            {noti.message}
                          </Link>
                        ))}
              ...
              <div className="custom-navbar__buttons">
                <Link
                  to="/signin"
                  className="custom-navbar__button custom-btn custom-btn--white"
                >
                  Login
                </Link>
                <Link
