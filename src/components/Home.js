            ...
            <React.Fragment>
                ...
                <div className="home">
                    ...
                    <div className="home__heart-logo-container">
                        <img src="http://placehold.it/100/100" className="home__heart-logo " alt="" />
                    ...
                    <div className="home__right-widget-container">
                        <img className="home__right-widget" src="" alt="" />
                    </div>
                    <div className="home__checknow-logo-container">
                        <img className="home__checknow-logo" src="http://placehold.it/100/100" alt="" />
                    </div>
